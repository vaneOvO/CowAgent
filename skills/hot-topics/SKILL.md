...
All endpoints use **GET** method and base URL: `https://60s.vaneus.ccwu.cc/v2`
...
def get_weibo_hot():
    response = requests.get('https://60s.vaneus.ccwu.cc/v2/weibo')
...
```python
def get_zhihu_hot():
    response = requests.get('https://60s.vaneus.ccwu.cc/v2/zhihu')
    return response.json()
...
def get_all_hot_topics():
    platforms = {
        'weibo': 'https://60s.vaneus.ccwu.cc/v2/weibo',
        'zhihu': 'https://60s.vaneus.ccwu.cc/v2/zhihu',
        'baidu': 'https://60s.vaneus.ccwu.cc/v2/baidu/hot',
        'douyin': 'https://60s.vaneus.ccwu.cc/v2/douyin',
        'bili': 'https://60s.vaneus.ccwu.cc/v2/bili'
    }
...
```bash
# Weibo hot search
curl "https://60s.vaneus.ccwu.cc/v2/weibo"

# Zhihu trending
curl "https://60s.vaneus.ccwu.cc/v2/zhihu"

# Baidu hot search
curl "https://60s.vaneus.ccwu.cc/v2/baidu/hot"

# Douyin trending
curl "https://60s.vaneus.ccwu.cc/v2/douyin"

# Bilibili trending
curl "https://60s.vaneus.ccwu.cc/v2/bili"
```
...
def check_trending_topic(keyword):
    ...
    for platform in platforms:
        url = f'https://60s.vaneus.ccwu.cc/v2/{platform}' if platform != 'baidu' else 'https://60s.vaneus.ccwu.cc/v2/baidu/hot'
