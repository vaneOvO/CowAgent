...
### 1. Real-time Weather
**URL:** `https://60s.vaneus.ccwu.cc/v2/weather/realtime`  
**Method:** GET

### 2. Weather Forecast
**URL:** `https://60s.vaneus.ccwu.cc/v2/weather/forecast`  
**Method:** GET
...
```bash
# Real-time weather
curl "https://60s.vaneus.ccwu.cc/v2/weather/realtime?query=北京"

# Weather forecast
curl "https://60s.vaneus.ccwu.cc/v2/weather/forecast?query=上海"
```
